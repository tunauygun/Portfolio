...
export default function Timeline({ title, items }: Props) {
  return (
    <section className="flex flex-col items-center justify-center px-6 sm:px-10">
      ...
      <div className="relative pl-6 grid gap-10 w-[80vw] md:w-[65vw] lg:w-[50vw] after:absolute after:inset-y-0 after:left-0 after:w-px after:bg-gray-500/20 dark:after:bg-gray-400/20">
        {items.map((item, index) => (
          ...
          <div key={index} className="relative grid gap-1 text-sm group transition-all" >
            ...
            {/* <div className="border-2 p-5 bg-primary-foreground">  */}
              <Card>
                <CardContent>
                {item}
                </CardContent>
